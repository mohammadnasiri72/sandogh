...
import ModalSndMssage from "./ModalSndMssage";
  ...
  return (
    <>
      <div className="flex flex-wrap items-center px-4">
        <div className="md:w-1/5 w-full px-2 md:mt-0 mt-3">
        ...
        <div className="px-2 md:mt-0 mt-3">
          <ModalSndMssage getListMessage={getListMessage} />
        </div>
      </div>
      <TableMessage
