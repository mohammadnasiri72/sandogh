...
export default function ModalDetailsFormContract({ loan }) {
  ...
  useEffect(() => {
    if (open) {
      setIsLoading(true);
      axios
        // .get(mainDomain + `/api/Form/Loan/${loan.loanId}/Current/${2}`, {
        .get(mainDomain + `/api/Form/Request/${loan.id}/Current/${1}`, {
          headers: {
