...
ModalDetailsFormPaymentOrder.propTypes = {
  open: PropTypes.bool,
  setOpen: PropTypes.func,
  loan: PropTypes.object,
};
export default function ModalDetailsFormPaymentOrder({ open, setOpen, loan }) {
  ...
  useEffect(() => {
    if (open) {
      setIsLoading(true);
      axios
        .get(mainDomain + `/api/Form/Loan/${loan.loanId}/Current/${3}`, {
          headers: {
