...
ConfirmDeleteLoanRequest.propTypes = {
  id: PropTypes.number,
  getLoanRequestList: PropTypes.func,
  openDel: PropTypes.bool,
};

export default function ConfirmDeleteLoanRequest({
  id,
  getLoanRequestList,
  openDel,
}) {
    ...
    <>
      ...
      {/* <div className="sm:hidden block">
        <div className="flex items-center">
          ...
          <span className="px-1 text-xs text-[#F82E32]">حذف</span>
        </div>
      </div> */}
      <Dialog
        open={open}
