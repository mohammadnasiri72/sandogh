...
ModalDetailsFormLoanRequest.propTypes = {
  open: PropTypes.bool,
  setOpen: PropTypes.func,
  loan: PropTypes.object,
};
export default function ModalDetailsFormLoanRequest({ open, setOpen, loan }) {
  ...
  useEffect(() => {
    if (open) {
      setIsLoading(true);
      axios
        .get(mainDomain + `/api/Form/Loan/${loan.loanId}/Current/${1}`, {
          headers: {
