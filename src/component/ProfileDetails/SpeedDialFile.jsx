...
//   { icon: <CloudDownloadIcon />, name: "دانلود" },
...
//   const colorHeader = useSelector((store) => store.setting.colorHeader);
...
//     link.href = mainDomain + fileUrl;
//     link.download = mainDomain + fileUrl.split("/").pop();
...
//     const printWindow = window.open(mainDomain + fileUrl, "_blank");
//     if (printWindow) {
//       printWindow.print();
//     }
//   };
...
//             width: "40px",
//             height: "40px",
//             background: colorHeader.main,
//             color: colorHeader.brigthness,
//           },
