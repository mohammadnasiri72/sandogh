...
import ModalAddShareHolder from "../ManageCooperative/ManageCooperativeDetails/ModalAddShareHolder";
import TableLegalShareHolder from "../ManageCooperative/ManageCooperativeDetails/TableLegalShareHolder";
import TableRealeShareHolder from "../ManageCooperative/ManageCooperativeDetails/TableRealeShareHolder";

ShareHolder.propTypes = {
  flag: PropTypes.bool,
};
export default function ShareHolder({ flag }) {
  const [isLoading, setIsLoading] = useState(true);
  const [listShareHolder, setListShareHolder] = useState([]);
  const [valSort, setValSort] = useState(1);
  const [valTypeSort, setValTypeSort] = useState(1);
