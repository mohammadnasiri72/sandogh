...
import ModalDetailsFormLoanRequestSucc from "./ModalDetailsFormLoanRequestSucc";
import ModalDetailsFormContractSucc from "./ModalDetailsFormContractSucc";
import FinalConfirm from "./FinalConfirm";

const StepFormTable = ({ loan, getLoanRequestAdminList, setPageIndex }) => {
  return (
    <>
      <div className="flex items-center justify-around pt-3">
        ...
        {<ModalDetailsFormLoanRequestSucc loan={loan} />}
        {<ModalDetailsFormContractSucc loan={loan} />}
        <FinalConfirm loan={loan}/>
      </div>
    </>
  );
};
StepFormTable.propTypes = {
  loan: PropTypes.object,
  getLoanRequestAdminList: PropTypes.func,
  setPageIndex: PropTypes.func,
};

export default StepFormTable;
