...
import TableCurentFile from "./TableCurentFile";
  ...
  export default function ModalCurentFile({ files, valItem, setFlag , item}) {
    ...
    const submitFormHandler = () => {
      ...
      const requests = selectedFiles.map((item) => {
        ...
        //     title: item.checkInfo.title,
        //     number:item.checkInfo.number,
        //     number2: item.checkInfo.number2,
        //     bankName:item.checkInfo.bankName,
        //     bankBranch:item.checkInfo.bankBranch,
        //     bankAccount: item.checkInfo.bankAccount,
        //     amount: Number(item.checkInfo.amount),
        //     dueDate: item.checkInfo.dueDate,
        //   } : '',
        };
    ...
    return (
      <>
        <Button
        disabled={loanRequestData.cooperativeLoanDocs.filter((e) => e.itemId === item.id)
          .length > 0}
