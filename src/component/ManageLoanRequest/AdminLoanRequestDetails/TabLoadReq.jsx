...
import ConfirmDeleteDoc from "../../LoanRequest/LoanRequestDetails/ConfirmDeleteDoc";
...
import ModalCurentFile from "./ModalCurentFile";
import ModalDetailsCheq from "./ModalDetailsCheq";
import ModalDetailsLetter from "./ModalDetailsLetter";
import ModalPendingLoanReq from "./ModalPendingLoanReq";
import ModalRejectLoanReq from "./ModalRejectLoanReq";

TabLoadReq.propTypes = {
  setValue: PropTypes.func,
  value: PropTypes.number,
  setFlag: PropTypes.func,
};
export default function TabLoadReq({ value, setValue, setFlag }) {
