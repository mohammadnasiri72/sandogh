...
import TabLoadReq from "./TabLoadReq";
import { IoIosArrowDown } from "react-icons/io";

MainPageAdminLoanRequestDetails.propTypes = {
  setValTabs: PropTypes.func,
};
export default function MainPageAdminLoanRequestDetails({ setValTabs }) {
  ...
  useEffect(() => {
    if (loanId === 0) {
      disPatch(
        setLoanId(url.pathname.substring(url.pathname.lastIndexOf("/") + 1))
      );
    }
  }, []);
  ...
  const submitContracting = () => {
    setIsLoading(true);
    axios
      .put(
        mainDomain + `/api/LoanRequest/${loanId}/ContractingParties`,
        mobileList,
        {
          headers: {
            Authorization: `Bearer ${user.token}`,
                ...
                <div className="md:w-1/2 w-full flex flex-wrap">
                  <div className="flex mt-3">
                    {loanRequestData.loanRequestDto.status === 2 && (
                      <div className="px-1">
                        <ModalConfirm setValTabs={setValTabs} />
                      </div>
                    )}

                    {loanRequestData.loanRequestDto.status === 2 && (
                      <div className="px-1">
                        <ModalReject setValTabs={setValTabs} />
                      </div>
                    )}
                  </div>
                  <div className="flex mt-3">
                    ...
                    {/* {loanRequestData.loanRequestDto.status === 4 && (
                      <div className="px-1">
                        <ModalVisitForm setValTabs={setValTabs} />
                      </div>
                    )} */}
                  </div>
                </div>
                <div className="md:w-1/2 w-full">
                  <div className=" w-full px-1 mt-3 flex">
                    <SelectContract setMobileList={setMobileList} />
                    <Button
                      size="large"
                      onClick={() => {
                        submitContracting();
              ...
              <div className="px-1">
                <div className="rounded-lg border p-3 w-full mt-3">
                  <div
                    ...
                    className="rounded-lg p-2 flex flex-wrap justify-between items-center cursor-pointer"
                  >
                    <div className="flex flex-wrap items-center">
                      <div className="flex items-center">
                        ...
                        <h3 className="px-2 font-extrabold select-none">
                          {loanRequestData.loanRequestDto.cooperativeTitle}
                        </h3>
                      </div>
                    ...
                    <div className="flex flex-wrap w-full">
                      ...
                      <div className="px-1 sm:w-1/2 w-full mt-2">
                        ...
                        >
                          ...
                          <span
                            dir="ltr"
                            className="text-xs whitespace-nowrap font-extrabold"
                          >
                            {loanRequestData.loanRequestDto.createdFa.slice(
                              0,
                              10
                            )}
                            <span className="px-1">-</span>
                            {loanRequestData.loanRequestDto.createdFa.slice(10)}
                          </span>
                        </div>
                      </div>
                      <div className="px-1 sm:w-1/2 w-full mt-2">
                        ...
                        >
                          ...
                          <span
                            ...
                            className="text-xs whitespace-nowrap font-extrabold"
                          >
                            {loanRequestData.loanRequestDto.modifiedFa.slice(
                              0,
                              10
                            )}
                            <span className="px-1">-</span>
