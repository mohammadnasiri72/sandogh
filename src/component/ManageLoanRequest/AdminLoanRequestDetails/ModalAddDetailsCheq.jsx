...
export default function ModalAddDetailsCheq({ setFlag, activeStep, item }) {
  ...
  //           Toast.fire({
  //             icon: "success",
  //             text: "افزودن چک با موفقیت ارسال شد",
  //             customClass: {
  //               container: "toast-modal",
  //             },
  //           });
  ...
  return (
    <>
      <div className="px-1 flex justify-center">
        {loanRequestData.cooperativeLoanDocs.filter((e) => e.itemId === item.id)
          .length > 0 && (
            ...
            <span>
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="px-1 whitespace-nowrap">افزودن چک</span>
                </div>
              </Button>
            </span>
          </Tooltip>
        ...
        <div className="flex flex-wrap">
          ...
          <div className="sm:w-1/2 w-full px-2 mt-3">
            {/* <TextField
              ...
              className="w-full"
              id="outlined-multiline-flexible"
              label={isCheck ? "عنوان چک*" : "عنوان سفته*"}
              name="name"
              onChange={(e) => {
              ...
              value={title}
              FormHelperTextProps={{ sx: { color: "red" } }}
              helperText={errTitle ? "لطفا عنوان چک را وارد کنید" : ""}
              sx={{
                "& .MuiOutlinedInput-root": {
                  "& fieldset": {
