...
import ModalDetailsFormPaymentOrderAdmin from "./ModalDetailsFormPaymentOrderAdmin";
import ModalDetailsFormInvoiceAdmin from "./ModalDetailsFormInvoiceAdmin";

ArchiveFormAdmin.propTypes = {
  loan: PropTypes.object,
};
export default function ArchiveFormAdmin({ loan }) {
  ...
  return (
    <>
      ...
      <ModalDetailsFormContractAdmin
        ...
        loan={loan}
      />
      <ModalDetailsFormPaymentOrderAdmin
        open={openFormPaymentOrder}
        setOpen={setOpenFormPaymentOrder}
        loan={loan}
      />
      <ModalDetailsFormInvoiceAdmin
