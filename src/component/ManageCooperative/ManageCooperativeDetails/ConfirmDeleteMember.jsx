...
ConfirmDeleteMember.propTypes = {
  id: PropTypes.number,
  setFlag: PropTypes.func,
};

export default function ConfirmDeleteMember({ id, setFlag }) {
  ...
  const deleteHandler = () => {
    ...
    axios
      .delete(mainDomain + `/api/Cooperative/Member/${id}`, {
        headers: {
