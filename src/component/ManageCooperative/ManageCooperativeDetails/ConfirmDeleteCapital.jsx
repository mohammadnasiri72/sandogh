...
ConfirmDeleteCapital.propTypes = {
  id: PropTypes.number,
  setFlag: PropTypes.func,
};

export default function ConfirmDeleteCapital({ id, setFlag }) {
  ...
  const deleteHandler = () => {
    ...
    axios
      // .delete(mainDomain + `/api/Cooperative/Capital/${id}`, {
      .delete(mainDomain + `/api/Capital/Capital/${id}`, {
        headers: {
