...
ConfirmDeleteCreditFile.propTypes = {
  id: PropTypes.number,
  setFlag: PropTypes.func,
};

export default function ConfirmDeleteCreditFile({ id, setFlag }) {
  ...
  const deleteHandler = () => {
    ...
    axios
      .delete(mainDomain + `/api/Cooperative/CreditFile/${id}`, {
        headers: {
