...
ConfirmDeleteShareHolder.propTypes = {
  id: PropTypes.number,
  getShareHolderList: PropTypes.func,
};

export default function ConfirmDeleteShareHolder({ id, getShareHolderList }) {
  ...
  const deleteHandler = () => {
    ...
    axios
      .delete(mainDomain + `/api/Cooperative/ShareHolder/${id}`, {
        headers: {
