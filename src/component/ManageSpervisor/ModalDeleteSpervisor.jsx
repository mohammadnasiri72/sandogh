...
ModalDeleteSpervisor.propTypes = {
  id: PropTypes.number,
  setFlag: PropTypes.func,
  openDel: PropTypes.bool,
};

export default function ModalDeleteSpervisor({ id, setFlag , openDel}) {
  ...
  const deleteHandler = () => {
    ...
    axios
      .delete(mainDomain + `/api/Supervisor/${id}`, {
        headers: {
    ...
    <>
      ...
      <div className="sm:hidden block">
        ...
        >
          ...
          <span className="px-1 text-xs sm:hidden text-[#F82E32]">حذف</span>
        </div>
      </div>
      <Dialog
        open={open}
