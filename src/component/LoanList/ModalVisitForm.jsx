...
ModalVisitForm.propTypes = {
  loan: PropTypes.object,
};
export default function ModalVisitForm({ loan }) {
  ...
  useEffect(() => {
    if (open) {
      axios
        .get(mainDomain + `/api/Form/Loan/${loan.id}/Current/${2}`, {
          headers: {
    ...
    <>
      ...
      >
        <div className="flex items-center">
          ...
          <span className="px-1 whitespace-nowrap">فایل قرارداد</span>
        </div>
      </Button>
      {/* <div className="px-1">
      ...
      >
       ...
       <div className="mt-20">
       {!formDetails && errMessage && <span>{errMessage}</span>}
       {!formDetails && !errMessage && <span>آیتمی یافت نشد</span>}
       </div>
      </Dialog>
    </>
  );
