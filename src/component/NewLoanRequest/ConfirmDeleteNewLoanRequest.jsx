...
import { setIsLoading } from "../../redux/slice/cooperative";
import { mainDomain } from "../../utils/mainDomain";
import Loader from "../loader";
import { useNavigate } from "react-router-dom";

ConfirmDeleteNewLoanRequest.propTypes = {
  id: PropTypes.number,
};

export default function ConfirmDeleteNewLoanRequest({ id }) {
  ...
  const deleteHandler = () => {
    ...
    handleClose();
    axios
      .delete(mainDomain + `/api/LoanRequest/${id}`, {
        headers: {
  ...
  return (
    <>
      <div className="px-2 sm:mt-0 mt-3">
        {/* <Tooltip title="حذف">
          <IconButton
        ...
        >
          <div className="flex items-center">
            ...
            <span className="px-1">حذف درخواست</span>
          </div>
        </Button>
      </div>
