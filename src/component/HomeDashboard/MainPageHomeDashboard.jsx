...
export default function MainPageHomeDashboard() {
  ...
  const [unSeenSign, setUnSeenSign] = useState(0);
  ...
  useEffect(() => {
    axios
      .get(mainDomain + `/api/ReferDoc/Cooperative/Unseen`, {
        headers: {
          Authorization: `Bearer ${user.token}`,
        },
      })
      .then((res) => {
        setUnSeenSign(res.data);
      })
      .catch(() => {});
  }, [mainPageState]);
            ...
            <div className="p-1 xl:w-1/2 w-full flex flex-wrap">
              <div className="px-1 sm:w-1/2 w-full">
                <div className="border rounded-lg p-2 h-full">
                  ...
                  className="w-full mt-3 rounded-lg px-1 flex justify-between py-4 border border-dashed"
                >
                  <div>
                    <span
                      style={{
                  ...
                  <div>
                    <Button
                      onClick={() => {
                        Navigate("/profile/referdoc", {
                          state: { unseenOnly: true },
                        });
                      }}
                      sx={{
                        background: themeColor.bgColor,
            ...
            <div className="xl:w-1/2 w-full flex flex-wrap px-2 py-1">
              <div className="border rounded-lg w-full flex flex-wrap items-start">
                <div className="px-2 sm:w-1/2 w-full mt-2">
                  ...
                  >
                    <span style={{ color: themeColor.color }}>کل تسهیلات</span>
                    <span
                ...
                <div className="px-2 sm:w-1/2 w-full mt-2">
                  <div
                    ...
                    className="rounded-lg w-full p-3 flex flex-col"
                  >
                    <span style={{ color: themeColor.color }}>کل دریافتی</span>
                    <span
                      style={{ fontWeight: 900 }}
                      className={
                        themeMode === "dark"
                ...
                <div className="px-2 sm:w-1/2 w-full mt-2">
                  ...
                  >
                    <span style={{ color: themeColor.color }}>بدهی جاری </span>
                    <span
                      style={{ fontWeight: 900 }}
                      className={
                        themeMode === "dark"
                ...
                <div className="px-2 sm:w-1/2 w-full mt-2">
                  <div
                    ...
                    className="rounded-lg w-full p-3 flex flex-col cursor-pointer hover:scale-105 duration-300"
                  >
                    <span style={{ color: themeColor.color }}>سررسید شده </span>
                    <span
                      style={{ fontWeight: 900 }}
                      className={
                        themeMode === "dark"
                          ...
                          >
                            <div className="flex items-center">
                              <img
                                ...
                                alt=""
                              />
                              <span className="px-2 text-xs">تاریخ ارسال</span>
                            </div>
                            <span className="text-xs font-semibold">
