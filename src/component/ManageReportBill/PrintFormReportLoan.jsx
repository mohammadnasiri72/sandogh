...
PrintFormReportLoan.propTypes = {
  getDataPrint: PropTypes.func,
  setFormDetails: PropTypes.func,
  formDetails: PropTypes.string,
  isLoadingPrint: PropTypes.bool,
};
export default function PrintFormReportLoan({getDataPrint, formDetails , setFormDetails , isLoadingPrint}) {
