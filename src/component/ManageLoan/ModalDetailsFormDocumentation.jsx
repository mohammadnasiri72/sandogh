...
ModalDetailsFormDocumentation.propTypes = {
  open: PropTypes.bool,
...
export default function ModalDetailsFormDocumentation({
  open,
  setOpen,
  flag,
  setFlag,
  ...
  useEffect(() => {
    if (open) {
      setIsLoading(true);
      axios
        .get(mainDomain + `/api/Form/Loan/${loanId}/${7}`, {
          headers: {
            Authorization: `Bearer ${user.token}`,
          },
        })
      ...
      >
        ...
        >
          <div className="px-4 flex gap-2">
            ...
            {status === 100 && LoanEdited?.formStatus >= 7 && (
              <ConfirmDeleteForm
                setFlagDel={setFlag}
                id={formId}
