...
ModalDetailsFormSupervisor.propTypes = {
  open: PropTypes.bool,
  setOpen: PropTypes.func,
};
export default function ModalDetailsFormSupervisor({ open, setOpen }) {
  ...
  const handleSubmit = () => {
    ...
    const data = {
      formId,
      body: JSON.stringify(formRef.current.innerHTML),
      description: "",
    };

    axios
      .post(mainDomain + `/api/Loan/${loanId}/Form/Supervisor`, data, {
        headers: {
  ...
  useEffect(() => {
    if (open) {
      setIsLoading(true);
      axios
        .get(mainDomain + `/api/Loan/${loanId}/Form/Supervisor`, {
          headers: {
            Authorization: `Bearer ${user.token}`,
          },
        })
      ...
      {/* <div className="px-2">
        ...
        >
          <div className="flex items-center">
            ...
            <span className="px-1 whitespace-nowrap">فرم ناظرین</span>
          </div>
        </Button>
      </div> */}
          ...
          <div className="px-4 flex gap-2">
            ...
            >
              <div className="flex items-center">
                ...
                <span className="px-1 whitespace-nowrap">ارسال فرم</span>
              </div>
            </Button>
          </div>
          <IconButton
